    ...
    <Fragment>
      ...
      <section className="w-full bg-white font-extrabold flex items-center flex-col gap-7 justify-center h-72">
        <div className="w-full h-auto">
          <h1 className="text-4xl text-center text-emerald-500">
        ...
        <div className="flex items-center justify-center flex-col gap-1">
          <input ref={inputRef} placeholder="Cut Url" className="sm:w-[600px] placeholder:text-emerald-500 focus:border-emerald-700 font-medium text-emerald-500 w-[calc(100vw_-_32px)] outline-none indent-3 h-14 rounded border border-emerald-500" />
          <button onClick={ onClick } className="sm:w-[600px] hover:bg-emerald-700 text-lg w-[calc(100vw_-_32px)] h-14 rounded bg-emerald-500 flex items-center justify-between">
