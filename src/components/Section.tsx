  ...
  return (
    <section className="max-sm:flex w-full h-auto items-center justify-center py-8 flex-wrap">
      <article className="px-4 py-1 block">
        <h2 className="sm:text-center text-emerald-500 font-extrabold text-xl">
          How to using?
        </h2>
        <p className="sm:m-auto sm:w-[600px] text-emerald-500 opacity-95 py-2">
      ...
      <article className="px-4 py-1 sm:flex sm:justify-center sm:items-center sm:flex-col">
        <div className="flex items-center gap-2">
          <Gear size={24} weight="fill" className="text-emerald-500" />
          <h2 className="sm:text-center text-xl font-extrabold text-emerald-500">
            About Api
          </h2>
        </div>
        <div className="py-2">
          <p className="sm:m-auto sm:w-[600px] text-emerald-500 opacity-95">
            <a href="#">
